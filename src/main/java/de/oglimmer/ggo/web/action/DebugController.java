...
public class DebugController extends BaseController {
	...
	public String show(@RequestParam(required = false) String pass, Model model, RedirectAttributes redirectAttributes) {
		if (pass == null || !GridGameOneProperties.PROPERTIES.getRuntimePassword().equals(pass)) {
		...
		Collection<GameNotification> gameNotifications = GameNotificationsDao.INSTANCE.all();
